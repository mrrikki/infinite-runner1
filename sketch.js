...
function setup() {
  canvas = createCanvas(800,320);

  background1 = createSprite(400,320,0,0);
  ...
  ground = createSprite(0,290,2200,10);
...
function spawnCoin() {
  ...
  if (frameCount % 60 === 0) {
    var coin = createSprite(750,420,2,2);
